...
export function App() {
  ...
  const {
    ...
    updateSiteData,
    handleGenerateSample, handleDeleteSite, handleUpdateSiteInfo, toggleSiteStatus,
  ...
  const { isDirty, performUndo, performRedo } = useUndo();
                ...
                >
                  ...
                  <div className="flex justify-between items-start mb-4">
                    ...
                    <div className="flex gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                      <button
                        onClick={(e) => { e.stopPropagation(); setSiteForm(site); setNoteInput({ content: '', author: '' }); setIsEditSiteModalOpen(true); }}
