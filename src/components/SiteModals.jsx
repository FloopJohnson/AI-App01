    ...
    <Modal title="Edit Site Details" onClose={onClose}>
      <div className="space-y-4">
        <div className={FORM_STYLES.section}>
          ...
          <div><label className={FORM_STYLES.label}>Logo</label><input type="file" accept="image/*" onChange={onLogoUpload} className="text-slate-400 text-xs" /></div>

          <div className="grid grid-cols-2 gap-4">
            <div><label className={FORM_STYLES.label}>Customer</label><input className={FORM_STYLES.input} placeholder="Customer" value={siteForm.customer || ''} onChange={e => setSiteForm({ ...siteForm, customer: e.target.value })} /></div>
            <div><label className={FORM_STYLES.label}>Name</label><input className={FORM_STYLES.input} placeholder="Name" value={siteForm.name || ''} onChange={e => setSiteForm({ ...siteForm, name: e.target.value })} /></div>
          </div>

          <div className="grid grid-cols-2 gap-4">
            <TypeSelect value={siteForm.type} onChange={e => setSiteForm({ ...siteForm, type: e.target.value })} />
            <div>
              <label className={FORM_STYLES.label}>Location Name</label>
              <input
                className={FORM_STYLES.input}
          ...
          <div className="mt-4 p-4 bg-slate-800/50 rounded-lg border border-slate-700">
            ...
            <div className="grid grid-cols-1 gap-4">
              {/* Street Address */}
              <div>
                <label className={FORM_STYLES.label}>Street Address</label>
                <input
                  className={FORM_STYLES.input}
              ...
              <div className="grid grid-cols-3 gap-4">
                {/* City */}
                <div>
                  <label className={FORM_STYLES.label}>City/Suburb</label>
                  <input
                    className={FORM_STYLES.input}
                ...
                {/* Postcode */}
                <div>
                  <label className={FORM_STYLES.label}>Postcode</label>
                  <input
                    className={FORM_STYLES.input}
                    placeholder="4810"
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                {/* Google Maps Link */}
                <div>
                  <label className={FORM_STYLES.label}>Google Maps Link</label>
                  <input
                    className={FORM_STYLES.input}
                ...
                <div className="span-col-2">
                  <label className={FORM_STYLES.label}>Photo Folder Link (OneDrive)</label>
                  <input
                    className={FORM_STYLES.input}
                    placeholder="https://..."
          ...
          {(siteForm.type === 'Other' || siteForm.type === 'Custom') && (
            <div>
              <label className={FORM_STYLES.label}>Custom Site Type</label>
              <input
                className={FORM_STYLES.input}
        ...
        <div className={FORM_STYLES.section}>
          ...
          <div className="grid grid-cols-2 gap-2">
            <input className={FORM_STYLES.input} placeholder="Contact Name" value={siteForm.contactName || ''} onChange={e => setSiteForm({ ...siteForm, contactName: e.target.value })} />
            <input className={FORM_STYLES.input} placeholder="Position" value={siteForm.contactPosition || ''} onChange={e => setSiteForm({ ...siteForm, contactPosition: e.target.value })} />
          </div>
          <input className={`${FORM_STYLES.input} mt-2`} placeholder="Email" value={siteForm.contactEmail || ''} onChange={e => setSiteForm({ ...siteForm, contactEmail: e.target.value })} />
          <div className="grid grid-cols-2 gap-2 mt-2">
            <input className={FORM_STYLES.input} placeholder="Phone 1" value={siteForm.contactPhone1 || ''} onChange={e => setSiteForm({ ...siteForm, contactPhone1: e.target.value })} />
            <input className={FORM_STYLES.input} placeholder="Phone 2" value={siteForm.contactPhone2 || ''} onChange={e => setSiteForm({ ...siteForm, contactPhone2: e.target.value })} />
          </div>
        </div>
